...
namespace SBX.MODEL
{
    public class cls_salida_para
    {
        ...
        //Metodos
        public DataTable mtd_consultar_salida_para()
        {
            v_query = " EXECUTE sp_consultar_salida_para '" + Nombre + "', '" + v_tipo_busqueda + "'";
        ...
        {
            v_query = " INSERT INTO SalidaPara VALUES(@Nombre) ";
        ...
        {
            v_query = "DELETE FROM SalidaPara WHERE Codigo = '" + Codigo + "'";
