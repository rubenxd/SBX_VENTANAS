...
namespace SBX.MODEL
{
    public class cls_mensajero
    {
        ...
        //Metodos
        public DataTable mtd_consultar_mensajero()
        {
            v_query = " EXECUTE sp_consultar_mensajero  '" + v_buscar + "','" + v_tipo_busqueda + "'";
        ...
        {
            v_query = " INSERT INTO Mensajero (DNI,Nombre,Ciudad,Direccion,Telefono,Celular,Email)" +
                      " VALUES (@DNI,@Nombre,@Ciudad,@Direccion,@Telefono,@Celular,@Email)";
        ...
        {
            v_query = " UPDATE Mensajero SET DNI = @DNI,Nombre = @Nombre,Ciudad = @Ciudad,Direccion = @Direccion,  " +
        ...
        {
            v_query = "DELETE FROM Mensajero WHERE Codigo = '" + Codigo + "'";
