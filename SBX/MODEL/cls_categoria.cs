...
namespace SBX.MODEL
{
    public class cls_categoria
    {
        ...
        //Metodos
        public DataTable mtd_consultar_categoria()
        {
            v_query = " EXECUTE sp_consultar_categoria '" + Nombre + "', '" + v_tipo_busqueda + "'";
        ...
        {
            v_query = " INSERT INTO Categoria VALUES(@Nombre) ";
        ...
        {
            v_query = "DELETE FROM Categoria WHERE Codigo = '" + Codigo + "'";
