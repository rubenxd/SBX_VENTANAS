...
namespace SBX.MODEL
{
    public class cls_unidad_medida
    {
        //instancias
        ...
        //Metodos
        public DataTable mtd_consultar_unidad_medida()
        {
            v_query = " EXECUTE sp_consultar_unidad_medida '"+Nombre+"', '"+ v_tipo_busqueda + "'";
        ...
        {
            v_query = " INSERT INTO UnidadMedida VALUES(@Nombre) ";
        ...
        {
            v_query = "DELETE FROM UnidadMedida WHERE Codigo = '" + Codigo + "'";
