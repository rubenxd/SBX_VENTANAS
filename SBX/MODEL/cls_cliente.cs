...
namespace SBX
{
    public class cls_cliente
    {
        ...
        {
           v_query = " EXECUTE sp_consultar_cliente  '" + v_buscar + "','" + v_tipo_busqueda + "'";
        ...
        {
            v_query = " INSERT INTO Cliente (DNI,Nombre,Ciudad,Direccion,Telefono,Celular,Email,SitioWeb)" +
        ...
        {
            v_query = " UPDATE Cliente SET DNI = @DNI,Nombre = @Nombre,Ciudad = @Ciudad,Direccion = @Direccion,  " +
        ...
        {
            v_query = "DELETE FROM Cliente WHERE Codigo = '" + Codigo + "'";
